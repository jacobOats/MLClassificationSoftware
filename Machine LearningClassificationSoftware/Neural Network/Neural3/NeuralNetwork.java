...
public class NeuralNetwork
{
    ...
    /*************************************************************************/
   //method to convert output of record
    ...
    /*************************************************************************/
   //method to convert output from record
    private int convertOut(double output) {
    	if(output >= .66)
    		return 2;
    	...
    	distance[1] = Math.sqrt((.5-output)*(.5-output));
    	distance[2] = Math.sqrt((0.0-output)*(0.0-output));
    	int minIndex = 0;

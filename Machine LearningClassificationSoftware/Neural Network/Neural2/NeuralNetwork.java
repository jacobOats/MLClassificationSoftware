...
public class NeuralNetwork
{
    ...
    /*************************************************************************/
   //method to convert output of a given file and write to given output file
    public void convertOutput(String inputFile, String outputFile) throws IOException {
		Scanner inFile = new Scanner(new File(inputFile));
	    PrintWriter outFile = new PrintWriter(new FileWriter(outputFile));
    ...
    /*************************************************************************/
    //method to convert output of a given record
    private String convertOut(double output) {
    	double[] distance = new double[4];
    	distance[0] = Math.sqrt((1.0-output)*(1.0-output));
    	distance[1] = Math.sqrt((.75-output)*(.75-output));
    	distance[2] = Math.sqrt((.5-output)*(.5-output));
    	distance[3] = Math.sqrt((.25-output)*(.25-output));
    	int minIndex = 0;
